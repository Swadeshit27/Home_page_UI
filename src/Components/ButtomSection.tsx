        ...
        <>
            <div className="w-full max-w-[1200px] mx-auto py-20 ">
                ...
                <div className="w-[90%] sm:w-3/5 mx-auto mt-6 ">
                    <h1 className="text-lg sm:text-xl font-medium text-fadeBlack text-center">Here is your last chance to explain how cool your app is. Focus on the benefits for your users, not on the features. </h1>
                    ...
                    <div className=" flex relative">
                        ...
                        <div className="w-[25rem] bg-[rgba(254,233,203,1)] p-4 rounded-2xl rounded-bl-none ms-20">
